...
class AppInvoice extends Model
{
    ...
    public function fixed(User $user, int $afterMonths = 1): void
    {
        ...
        //Uma ou mais contas fixas, controlar uma por vez - $fixedItem é a fatura principal selecionada para lançamento das filhas
        foreach ($fixed as $fixedItem) {
            ...
            //Pegando os períodos de lancçamentos por data, ex: 01/2020, 02/2020, 03/2020....
            $period = new \DatePeriod($start, $interval, $end);
            foreach ($period as $item) {

                //Verificando a existência da fatura no mês (item -> periodo)
