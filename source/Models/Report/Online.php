...
class Online extends Model
{
    ...
    public function report(bool $clear = true): Online
    {
        ...
        if (!$session->has("online")) {
            $this->user = ($session->authUser ?? null); //id do usuário logado
        ...
        //Verificando sessão ativa e se existe um registro
        ...
        $find->user = ($session->authUser ?? null); //id do usuário logado
